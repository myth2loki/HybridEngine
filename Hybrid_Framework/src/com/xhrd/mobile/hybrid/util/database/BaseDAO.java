...
import com.xhrd.mobile.hybrid.util.database.annotation.DatabaseAutoIncrement;
import com.xhrd.mobile.hybrid.util.database.annotation.DatabaseColumn;
import com.xhrd.mobile.hybrid.util.database.annotation.DatabaseIndex;
import com.xhrd.mobile.hybrid.util.database.annotation.DatabaseOneToMany;
import com.xhrd.mobile.hybrid.util.database.annotation.DatabasePrimaryKey;
import com.xhrd.mobile.hybrid.util.database.annotation.DatabaseTable;
import com.xhrd.mobile.hybrid.util.database.annotation.DatabaseUnique;
