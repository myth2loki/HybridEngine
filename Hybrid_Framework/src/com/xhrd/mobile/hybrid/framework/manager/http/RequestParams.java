...
import com.xhrd.mobile.hybrid.framework.manager.http.client.entity.BodyParamsEntity;
import com.xhrd.mobile.hybrid.framework.manager.http.client.multipart.HttpMultipartMode;
import com.xhrd.mobile.hybrid.framework.manager.http.client.multipart.MultipartEntity;
import com.xhrd.mobile.hybrid.framework.manager.http.client.multipart.content.ContentBody;
import com.xhrd.mobile.hybrid.framework.manager.http.client.multipart.content.FileBody;
import com.xhrd.mobile.hybrid.framework.manager.http.client.multipart.content.InputStreamBody;
import com.xhrd.mobile.hybrid.framework.manager.http.client.multipart.content.StringBody;
import com.xhrd.mobile.hybrid.framework.manager.http.task.Priority;
import com.xhrd.mobile.hybrid.framework.manager.http.util.HttpLU;
