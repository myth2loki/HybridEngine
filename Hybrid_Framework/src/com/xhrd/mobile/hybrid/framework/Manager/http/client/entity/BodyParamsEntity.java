...
package com.xhrd.mobile.hybrid.framework.Manager.http.client.entity;


import com.xhrd.mobile.hybrid.framework.Manager.http.client.util.URLEncodedUtils;
...
public class BodyParamsEntity extends AbstractHttpEntity implements Cloneable {
    ...
    public BodyParamsEntity(String content, String charset) {
        super();
        if (charset != null) {
            this.charset = charset;
        }
