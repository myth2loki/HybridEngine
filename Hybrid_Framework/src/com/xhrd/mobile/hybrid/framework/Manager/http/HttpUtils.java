...
import com.xhrd.mobile.hybrid.framework.Manager.http.callback.HttpRedirectHandler;
import com.xhrd.mobile.hybrid.framework.Manager.http.callback.RequestCallBack;
import com.xhrd.mobile.hybrid.framework.Manager.http.client.DefaultSSLSocketFactory;
import com.xhrd.mobile.hybrid.framework.Manager.http.client.RetryHandler;
import com.xhrd.mobile.hybrid.framework.Manager.http.client.entity.GZipDecompressingEntity;
import com.xhrd.mobile.hybrid.framework.Manager.http.task.PriorityExecutor;
import com.xhrd.mobile.hybrid.framework.Manager.http.util.OtherUtils;
import com.xhrd.mobile.hybrid.framework.Manager.http.client.HttpRequest;
import com.xhrd.mobile.hybrid.framework.Manager.http.exception.HttpException;
...
public class HttpUtils {
    ...
    public HttpUtils() throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException {
        this(HttpUtils.DEFAULT_CONN_TIMEOUT);
    }

    public HttpUtils(int connTimeout) throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException {
        this(connTimeout, null,null,null);
    }

    public HttpUtils(String userAgent) throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException {
        this(HttpUtils.DEFAULT_CONN_TIMEOUT, userAgent,null,null);
    }

    public HttpUtils(int connTimeout, String userAgent,InputStream inputStream,char[] passWord) throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException {
        ...
        if (inputStream!=null&&passWord!=null){
            schemeRegistry.register(new Scheme("https", DefaultSSLSocketFactory.getSocketFactory(inputStream,passWord), 443));
        }else{
