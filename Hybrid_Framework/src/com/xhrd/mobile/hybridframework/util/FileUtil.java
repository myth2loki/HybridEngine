...
public class FileUtil {
    ...
    public static void copyFile(String oldPathFile, String newPathFile) {
        try {
            ...
            ///data/data/com.xhrd.mobile.hybridframework/lib
            message = ("复制单个文件操作出错");
        }
    }
     ...
     * @param oldPath 准备拷贝的目录
     * @param newPath 指定绝对路径的新目录
     * @param isDelTargetDir 是否删除
     * @return
     */
    public static void copyFolder(String oldPath, String newPath,boolean isDelTargetDir) {
        try {
     ...
     * @return
     */
    public static boolean isExists(String pPath) {
    ...
    public static String getMimeType(String filename) {
        ...
        if (lastIdx >= 0) {
            mime = filename.substring(lastIdx + 1, filename.length());
            MimeTypeMap mtm = MimeTypeMap.getSingleton();
            mime = mtm.getMimeTypeFromExtension(mime);
            if (mime == null) {
                mime = "*/*";
            }
        }
